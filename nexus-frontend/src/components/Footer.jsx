                    ...
                    <div className="md:col-span-6 lg:col-span-4 space-y-4">
                        ...
                        <div className="pt-3 flex items-center gap-3">
                            ...
                            <a
                                ...
                                className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-600 hover:text-white hover:bg-[#0077b5] hover:border-[#0077b5] shadow-sm transition transform hover:-translate-y-0.5"
                            >
                            ...
                            <a
                                ...
                                className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-600 hover:text-white hover:bg-slate-900 hover:border-slate-900 shadow-sm transition transform hover:-translate-y-0.5"
                            >
                                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                            ...
                            <a
                                ...
                                className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-600 hover:text-white hover:bg-[#fc6d26] hover:border-[#fc6d26] shadow-sm transition transform hover:-translate-y-0.5"
                            >
                                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                            ...
                            <a
                                ...
                                title="Email Antonis"
                                className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-600 hover:text-white hover:bg-[#ff014f] hover:border-[#ff014f] shadow-sm transition transform hover:-translate-y-0.5"
                            >
                                <Mail className="w-4 h-4" />
                            </a>
                        </div>
