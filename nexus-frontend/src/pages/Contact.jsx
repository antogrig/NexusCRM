                    ...
                    <div className="bg-white border border-slate-200/80 rounded-3xl p-8 space-y-6 shadow-sm">
                        ...
                        <div className="space-y-4">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex items-center gap-4 text-slate-700 hover:text-[#0077b5] transition group"
                            >
                                <div className="w-12 h-12 rounded-2xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 group-hover:text-[#0077b5] group-hover:border-[#0077b5]/40 shadow-sm transition">
                                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                                        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                                    </svg>
                                </div>
                                <div>
                                    <div className="text-[10px] text-slate-400 uppercase font-black tracking-wider">LinkedIn</div>
                                    <div className="font-mono text-xs sm:text-sm font-semibold text-slate-900 group-hover:text-[#0077b5] transition">linkedin.com/in/antonis-grigoriadis</div>
                                </div>
                            </a>
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex items-center gap-4 text-slate-700 hover:text-slate-900 transition group"
                            >
                                <div className="w-12 h-12 rounded-2xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 group-hover:text-slate-900 group-hover:border-slate-900/40 shadow-sm transition">
                                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                                ...
                                <div>
                                    <div className="text-[10px] text-slate-400 uppercase font-black tracking-wider">GitHub</div>
                                    <div className="font-mono text-xs sm:text-sm font-semibold text-slate-900 group-hover:text-[#ff014f] transition">github.com/antogrig</div>
                                </div>
                            </a>
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex items-center gap-4 text-slate-700 hover:text-[#fc6d26] transition group"
                            >
                                <div className="w-12 h-12 rounded-2xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 group-hover:text-[#fc6d26] group-hover:border-[#fc6d26]/40 shadow-sm transition">
                                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                                ...
                                <div>
                                    <div className="text-[10px] text-slate-400 uppercase font-black tracking-wider">GitLab</div>
                                    <div className="font-mono text-xs sm:text-sm font-semibold text-slate-900 group-hover:text-[#fc6d26] transition">gitlab.com/antogrig</div>
                                </div>
                            </a>
                        </div>
                    </div>
