                ...
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 w-full">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                            ...
                            {/* Find Me On / Social Quick Badges */}
                            <div className="pt-6 flex flex-wrap items-center justify-center lg:justify-start gap-3 text-xs text-slate-500 font-semibold">
                                <span className="uppercase tracking-widest text-[11px] text-slate-400">
                                    {lang === 'el' ? 'Βρείτε με στο:' : 'Find with me:'}
                                </span>
                                <div className="flex items-center gap-2">
                                    <a
                                        href={t?.contact?.linkedin || 'https://www.linkedin.com/in/antonis-grigoriadis/'}
                                        target="_blank"
                                        rel="noreferrer"
                                        aria-label="LinkedIn"
                                        title="LinkedIn Profile"
                                        className="w-9 h-9 rounded-xl bg-white border border-slate-200/80 shadow-sm flex items-center justify-center text-slate-600 hover:bg-[#0077b5] hover:text-white hover:border-[#0077b5] transition-all transform hover:-translate-y-0.5"
                                    >
                                    ...
                                    <a
                                        href={t?.contact?.github || 'https://github.com/antogrig'}
                                        target="_blank"
                                        rel="noreferrer"
                                        aria-label="GitHub"
                                        title="GitHub Profile"
                                        className="w-9 h-9 rounded-xl bg-white border border-slate-200/80 shadow-sm flex items-center justify-center text-slate-600 hover:bg-slate-900 hover:text-white hover:border-slate-900 transition-all transform hover:-translate-y-0.5"
                                    >
                                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                                    ...
                                    <a
                                        href={t?.contact?.gitlab || 'https://gitlab.com/antogrig'}
                                        target="_blank"
                                        rel="noreferrer"
                                        aria-label="GitLab"
                                        title="GitLab Profile"
                                        className="w-9 h-9 rounded-xl bg-white border border-slate-200/80 shadow-sm flex items-center justify-center text-slate-600 hover:bg-[#fc6d26] hover:text-white hover:border-[#fc6d26] transition-all transform hover:-translate-y-0.5"
                                    >
                                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                        ...
                        <div className="lg:col-span-5 space-y-6">
                            ...
                            <div className="pt-4 space-y-3">
                                ...
                                <a
                                    ...
                                    className="flex items-center gap-3 text-sm text-slate-700 hover:text-[#ff014f] transition group"
                                >
                                    <div className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-500 group-hover:text-[#0077b5] group-hover:border-[#0077b5]/30 shadow-sm transition">
                                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                                            <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                                        </svg>
                                    </div>
                                    <span className="font-mono text-xs sm:text-sm text-slate-600 group-hover:text-[#ff014f] transition">linkedin.com/in/antonis-grigoriadis</span>
                                </a>
                                ...
                                <a
                                    ...
                                    className="flex items-center gap-3 text-sm text-slate-700 hover:text-[#ff014f] transition group"
                                >
                                    <div className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-500 group-hover:text-slate-900 group-hover:border-slate-900/30 shadow-sm transition">
                                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.53 1.032 1.53 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" />
                                        </svg>
                                    </div>
                                    <span className="font-mono text-xs sm:text-sm text-slate-600 group-hover:text-[#ff014f] transition">github.com/antogrig</span>
                                </a>
                                ...
                                <a
                                    ...
                                    className="flex items-center gap-3 text-sm text-slate-700 hover:text-[#ff014f] transition group"
                                >
                                    <div className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-500 group-hover:text-[#fc6d26] group-hover:border-[#fc6d26]/30 shadow-sm transition">
                                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                                            <path d="M22.65 14.39L20 6.21a.75.75 0 00-1.42 0l-2.65 8.18H8.07L5.42 6.21a.75.75 0 00-1.42 0L1.35 14.39a1.5 1.5 0 00.54 1.68l10.11 7.34a1.5 1.5 0 001.78 0l10.11-7.34a1.5 1.5 0 00.54-1.68z" />
                                        </svg>
                                    </div>
                                    <span className="font-mono text-xs sm:text-sm text-slate-600 group-hover:text-[#ff014f] transition">gitlab.com/antogrig</span>
                                </a>
                            </div>
                        </div>
