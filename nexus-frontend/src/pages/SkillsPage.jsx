        ...
        <div className="space-y-12 py-4">
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm text-center space-y-3">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-700 text-xs font-semibold">
                    ...
                    <span>Technical Competencies & Career History</span>
                </div>
                <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">
                    Τεχνολογικό Stack & Επαγγελματική Διαδρομή
                </h1>
                <p className="text-slate-500 text-sm max-w-2xl mx-auto leading-relaxed">
                    Αναλυτικός πίνακας δεξιοτήτων σε Full-Stack Web Engineering και Unreal Engine 5, σε συνδυασμό με τα κυριότερα επαγγελματικά ορόσημα.
                </p>
                        ...
                        <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-400">
                                    {cat.skills.length} Εξειδικευμένες Τεχνολογίες
                                </p>
                            </div>
                        </div>
                ...
                <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-slate-900">
                            Επαγγελματική Διαδρομή & Έργα
                        </h2>
                        <p className="text-xs text-slate-500">
                            Ιστορικό υλοποιήσεων enterprise συστημάτων και game mechanics.
                        </p>
                    </div>
                </div>
